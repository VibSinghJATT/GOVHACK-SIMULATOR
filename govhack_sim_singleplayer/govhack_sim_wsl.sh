#!/bin/bash
# =========================================================
# GOVHACK SIMULATOR — RPG/Arcade Prototype
# Created by: VibSingh
# GitHub: https://github.com/VibSinghJATT & https://github.com/Omgindia1234
# SAFE — TERMINAL ONLY, MODULAR DESIGN
# Features:
# - Real-time mini-games (keypress, no Enter)
# - Multi-phase adaptive boss AI
# - Inventory + Skill Tree
# - Open-world maps with NPC events
# - Modular multiplayer (host/join/spectator)
# - Fun Commands menu (runs fortune, cowsay, lolcat, genact, hollywood, cmatrix, sl)
# =========================================================
...
╚██████╔╝╚██████╔╝╚██████╔╝██║  ██║██║  ██║╚██████╗██║  ██╗
 ╚═════╝  ╚═════╝  ╚═════╝ ╚═╝  ╚═╝╚═╝  ╚═╝ ╚═════╝╚═╝  ╚═╝
EOF
echo "GOVHACK SIMULATOR — RPG/Arcade Prototype"
...
check_dependency(){
    ...
    if ! command -v "$cmd" >/dev/null 2>&1; then
        read -p "⚠️ $cmd ($pkg) is missing. Install it? (y/N) " yn
        case $yn in
